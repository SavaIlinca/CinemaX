	...
	<div class="wrap">
		<div class="content-top">
				<div class="listview_1_of_3 images_1_of_3">
					<h2 style="color:#555;">Filme viitoare</h2>
					<?php 
				...
				<div class="content-left">
					...
					<div class="text list_1_of_2">
						  <div class="extra-wrap">
						  	...
						  	<span style="text-color:#000" class="data"><strong>Distribuție: <?php echo $n['cast'];?></strong><br>
                                <div class="data">Data lansării: <?php echo $n['news_date'];?></div>
		...
		<div class="listview_1_of_3 images_1_of_3">
					...
					<?php 
					$qry4=mysqli_query($con,"SELECT * FROM movie ORDER BY rand() LIMIT 6");
